...
const SegmentCard: React.FC<SegmentCardProps> = ({
  ...
  return (
    <div ref={cardRef} className="relative mx-auto flex h-full min-h-0 w-full max-w-md flex-col rounded-2xl border border-gray-200 bg-white px-4 py-3 shadow-md sm:px-6 sm:py-5">
