    ...
    <div className="space-y-4">
      ...
      <div className="flex flex-wrap items-center gap-2">
        ...
        <button
          ...
          className={`flex min-h-11 items-center gap-1.5 rounded-lg px-3 py-2 text-sm transition-colors ${
            showFilter ? 'bg-indigo-50 text-indigo-700' : 'text-gray-500 hover:bg-gray-100'
          }`}
        >
        ...
        {displayedSongs.map((song) => {
          ...
          >
            ...
            {selectedSongId === song.id && (
              <div className="mt-2 text-sm text-indigo-600 font-medium" data-testid={`song-selected-${song.id}`}>
                Currently Selected
              </div>
            )}
            {isEditMode ? (
              <div className="mt-4">
                <button
                  ...
                  className="relative z-10 min-h-11 rounded-lg px-2 text-sm text-red-600 hover:bg-red-50 hover:text-red-700 disabled:opacity-50"
                >
