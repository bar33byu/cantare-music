...
import { finishSongPracticeSession } from "../../../../db/queries";
...
export async function PATCH(request: NextRequest, context: { params: Promise<{ id: string }> }) {
  try {
    ...
    const session = await finishSongPracticeSession({
      id,
    ...
    console.error("Error finishing song practice session:", error);
